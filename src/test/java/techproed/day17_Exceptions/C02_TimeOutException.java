...
public class C02_TimeOutException extends TestBase {
    ...
    public void test03() {
        ...
        //CheckBox yazan butona tiklayin
        ...
        wait.until(ExpectedConditions.invisibilityOf(checkBox));        //Burada .elementToBeSelected metodu kullanmamiz gerekiyordu
        Assert.assertTrue(checkBox.isSelected());                       //yanlis method kullandigimiz icin timeout exception aldik.
